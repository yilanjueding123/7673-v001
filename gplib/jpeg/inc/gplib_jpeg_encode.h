...
extern INT32S jpeg_quant_luminance_set_table(INT32U offset, INT32U len, INT16U *val);
extern INT32S jpeg_quant_chrominance_set_table(INT32U offset, INT32U len, INT16U *val);
